...
QT_MOC_LITERAL(5, 51, 8), // "canceled"
QT_MOC_LITERAL(6, 60, 7), // "aborted"
QT_MOC_LITERAL(7, 68, 15), // "onAcceptClicked"
QT_MOC_LITERAL(8, 84, 15), // "onRejectClicked"
QT_MOC_LITERAL(9, 100, 15), // "onCancelClicked"
QT_MOC_LITERAL(10, 116, 14) // "onAbortClicked"

    },
    "EventNotificationWidget\0accepted\0\0"
    "comment\0rejected\0canceled\0aborted\0"
    "onAcceptClicked\0onRejectClicked\0"
    "onCancelClicked\0onAbortClicked"
};
...
static const uint qt_meta_data_EventNotificationWidget[] = {
 ...
 // signals: name, argc, parameters, tag, flags
       ...
       5,    0,   85,    2, 0x26 /* Public | MethodCloned */,
...
void EventNotificationWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->aborted((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 7: _t->aborted(); break;
        case 8: _t->onAcceptClicked(); break;
        case 9: _t->onRejectClicked(); break;
        case 10: _t->onCancelClicked(); break;
        case 11: _t->onAbortClicked(); break;
        default: ;
        }
        ...
        {
            using _t = void (EventNotificationWidget::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EventNotificationWidget::canceled)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (EventNotificationWidget::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EventNotificationWidget::aborted)) {
                *result = 6;
                return;
            }
        }
...
// SIGNAL 4
void EventNotificationWidget::canceled(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 6
void EventNotificationWidget::aborted(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
