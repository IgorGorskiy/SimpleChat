...
QT_MOC_LITERAL(1, 13, 17), // "messageReadyForDB"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 11), // "ChatMessage"
QT_MOC_LITERAL(4, 44, 7), // "message"
QT_MOC_LITERAL(5, 52, 19), // "updateMessageStatus"
QT_MOC_LITERAL(6, 72, 9), // "sentMsgId"
QT_MOC_LITERAL(7, 82, 19), // "ChatMessage::Status"
QT_MOC_LITERAL(8, 102, 9) // "newStatus"

    },
    "MessageModel\0messageReadyForDB\0\0"
    "ChatMessage\0message\0updateMessageStatus\0"
    "sentMsgId\0ChatMessage::Status\0newStatus"
};
...
void MessageModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->messageReadyForDB((*reinterpret_cast< ChatMessage(*)>(_a[1]))); break;
        case 1: _t->updateMessageStatus((*reinterpret_cast< quint32(*)>(_a[1])),(*reinterpret_cast< ChatMessage::Status(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            using _t = void (MessageModel::*)(ChatMessage );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MessageModel::messageReadyForDB)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MessageModel::messageReadyForDB(ChatMessage _t1)
{
